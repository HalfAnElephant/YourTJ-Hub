...
describe('Schedule 移动端回归', () => {
  ...
  test('导出菜单小屏向右展开，sm 起恢复向左对齐', () => {
    const source = readFileSync(resolve(__dirname, '../src/site/pages/SchedulePage.vue'), 'utf8')
    expect(source).toContain('left-0 right-auto sm:left-auto sm:right-0')
  })
